public class NotificationService {
    public NotificationService(EmergencyAlert alert) {
          }
    ...
    public void press(int patientId, String patientAddress, String patientName, String doctorEmail, String hospitalEmail, String emergencyContactEmail) {
        sendNotificationToDoctor(patientId, patientAddress, patientName, doctorEmail);
        sendNotificationToHospital(patientAddress, patientName, hospitalEmail);
        sendNotificationToEmergencyContact(patientAddress, patientName, emergencyContactEmail);
    }
